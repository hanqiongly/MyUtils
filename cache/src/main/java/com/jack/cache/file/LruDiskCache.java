...
import com.jack.cache.db.config.DbConfigs;
...
import com.jack.cache.file.lock.ProcessLock;
import com.jack.cache.utils.FileUtil;
...
public final class LruDiskCache {
    ...
    private LruDiskCache(String dirName) {
        this.cacheDb = DbManagerImpl.getInstance(DbConfigs.HTTP.getConfig());
    ...
    public DiskCacheEntity get(String key) {
        ...
        if (result != null) {
            ...
            { // update hint & lastAccess...
                ...
                cacheDb.startAsyncAction(new Runnable() {
                    @Override
                    public void run() {
