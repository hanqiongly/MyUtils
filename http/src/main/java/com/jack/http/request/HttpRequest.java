...
import com.jack.http.cookie.DbCookieStore;
import com.jack.http.data.HttpKeyValue;
import com.jack.http.exception.HttpException;
import com.jack.http.request.body.ProgressBody;
...
public class HttpRequest extends UriRequest {
    ...
    protected String buildQueryUrl(RequestParams params) {
        ...
        List<HttpKeyValue> queryParams = params.getQueryStringParams();
        if (queryParams != null) {
            for (HttpKeyValue kv : queryParams) {
                String name = kv.key;
