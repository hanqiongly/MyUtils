package com.jack.http.request.body;
...
public class MultipartBody implements ProgressBody {
    ...
    private List<HttpKeyValue> multipartParams;
    private long total = 0;
    private long current = 0;

    public MultipartBody(List<HttpKeyValue> multipartParams, String charset) {
    ...
    public void writeTo(OutputStream out) throws IOException {
        ...
        for (HttpKeyValue kv : multipartParams) {
            String name = kv.key;
