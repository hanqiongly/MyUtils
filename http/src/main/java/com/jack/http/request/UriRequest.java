...
import com.jack.http.request.loader.Loader;
import com.jack.http.request.loader.LoaderFactory;
...
public abstract class UriRequest implements Closeable {
    ...
    public UriRequest(RequestParams params, Type loadType) throws Throwable {
        ...
        httpManager = HttpManagerImpl.getInstance(null);
    }
    ...
    public void save2Cache() {
        httpManager.startAsyncAction(new Runnable() {
            @Override
            public void run() {
                try {
